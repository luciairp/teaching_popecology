...
# va a graficar Nd en el tiempo
# GRÁFICO 1
plot(c(1:10),Nd,type='b',cex.lab=0.8,ylab='N',xlab='tiempo',cex.axis=0.8,las=1)

# va a graficar el log de Nd en el tiempo
# GRÁFICO 2
plot(c(1:10),log(Nd), xlab='tiempo')

# va a graficar el reclutamiento proporcional según el tamaño poblacional
# GRÁFICO 3
...
# ahora el log de los valores en el eje y en el tiempo
# GRÁFICO 5
